        ...
        <div className="min-h-screen bg-[#050914] text-white">
            ...
            <section className="relative overflow-hidden border-b border-white/10">
                ...
                <div className="relative max-w-7xl mx-auto px-4 pt-10 pb-16">
                    ...
                    {/* Banner */}
                    <div className="mt-10 relative h-[250px] sm:h-[380px] lg:h-[460px] overflow-hidden rounded-3xl border border-white/10 bg-white/5 shadow-2xl object-cover">
                        <img
                            src={bannerImage}
                            alt={blog?.title || "blog"}
                            fill
            ...
            <section className="py-14">
                <div className="max-w-7xl mx-auto px-4 grid grid-cols-12 gap-10">
                    {/* Content */}
                  ...
                  prose-img:rounded-2xl"
                            ...
                            <CardFooter className="p-6 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
                                <Button
                                    asChild
                                ...
                                <Card className="rounded-3xl bg-white/5 border border-white/10 overflow-hidden">
                                    ...
                                    <CardContent className="p-4 space-y-3">
                                        {latest.slice(0, 5).map((b) => {
                                            ...
                                            const img = imgPath
                                                ? `${IMAGE_URL}${imgPath}`
                                                : "https://via.placeholder.com/200x200?text=Blog";
